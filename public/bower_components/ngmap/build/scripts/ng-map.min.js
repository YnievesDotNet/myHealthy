angular.module("ngMap", []), function () {
    ...
    var e, t = function (t, n, o, i, r, a) {
        ...
        s.mapOptions, s.mapEvents, s.ngMapDiv, s.addObject = function (e, t) {
            if (s.map) {
                ...
                s.map[e][t.id || n] = t, s.map instanceof google.maps.Map && ("infoWindows" != e && t.setMap && t.setMap && t.setMap(s.map), t.centered && t.position && s.map.setCenter(t.position), "markers" == e && s.objectChanged("markers"), "customMarkers" == e && s.objectChanged("customMarkers"))
            }
            ...
            var e = s.mapOptions, n = s.mapEvents, r = s.ngMapDiv, c = s.map;
            if (s.map = new google.maps.Map(r, {}), c)for (var u in c) {
                var l = c[u];
                if ("object" == typeof l)for (var g in l)s.addObject(u, l[g])
            }
            e.zoom = e.zoom || 15;
            var d = e.center;
            if (!e.center || "string" == typeof d && d.match(/\{\{.*\}\}/))e.center = new google.maps.LatLng(0, 0); else if (!(d instanceof google.maps.LatLng)) {
                var f = e.center;
                delete e.center, a.getGeoLocation(f, e.geoLocationOptions).then(function (n) {
                    s.map.setCenter(n);
                    var o = e.geoCallback;
                    o && i(o)(t)
                }, function () {
            ...
            s.map.setOptions(e);
            for (var m in n)google.maps.event.addListener(s.map, m, n[m]);
    ...
    var e, t, n, o, i, r, a, s = {}, p = function (e) {
        var t = s[e || 0];
        t.map instanceof google.maps.Map || t.initializeMap()
    }, c = function (t) {
        function o(t) {
