                ...
                return c(h, e), h.include(g), h.prototype.restrict = "EMA", h.prototype.transclude = !0, h.prototype.replace = !1, h.prototype.template = '<div class="angular-google-map"><div class="angular-google-map-container">\n</div><div ng-transclude style="display: none"></div></div>', h.prototype.scope = {
                    ...
                    return g = [], a.$on("$destroy", function () {
                        ...
                        return function (i) {
                            ...
                            if (q = {mapTypeId: i.MapTypeId.ROADMAP}, A = j.spawn(), y = function () {
                                    return A.deferred.resolve({instance: A.instance, map: l})
                            ...
                            if (r = b.element(c), r.addClass("angular-google-map"), w = {options: {}}, e.options && (w.options = a.options), e.styles && (w.styles = a.styles), e.type && (B = e.type.toUpperCase(), google.maps.MapTypeId.hasOwnProperty(B) ? w.mapTypeId = google.maps.MapTypeId[e.type.toUpperCase()] : f.error("angular-google-maps: invalid map type '" + e.type + "'")), u = b.extend({}, q, w, {
                                    ...
                                    return _.contains(n, b) ? void 0 : (d && d(), g.push(google.maps.event.addListener(l, b, function () {
                                        var b;
                                    ...
                                    if (null == c && (c = l.center), null == d && (d = a), !_.contains(n, "center"))if (b.isDefined(d.center.type)) {
                                    ...
                                    return b = l.getBounds(), c = b.getNorthEast(), d = b.getSouthWest(), z = !0, a.$evalAsync(function (b) {
                                        return C(), _.isUndefined(b.bounds) || _.contains(n, "bounds") || (b.bounds.northeast = {
                                            latitude: c.lat(),
                                            longitude: c.lng()
                                        }, b.bounds.southwest = {
                                            latitude: d.lat(),
                                            longitude: d.lng()
                                        }), _.contains(n, "zoom") || (b.zoom = l.zoom, a.idleAndZoomChanged = !a.idleAndZoomChanged), z = !1
                                    })
