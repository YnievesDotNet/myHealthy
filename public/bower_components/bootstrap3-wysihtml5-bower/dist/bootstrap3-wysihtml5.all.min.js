    ...
    return typeof window == t ? void i("No window found") : typeof document == t ? void i("No document found") : (a(document, "addEventListener") && document.addEventListener("DOMContentLoaded", H, !1), D(window, "load", H), C.createCoreModule("DomUtil", [], function (a, b) {
        ...
        if (a.features.implementsDomRange && !function () {
            ...
            var l = function (a) {
                ...
                return l.parentNode.removeChild(l), {boundaryPosition: p, nodeInfo: {nodeIndex: v, containerElement: i}}
            }, o = function (a, b) {
...
Base.extend = function (a, b) {
        ...
        return {
            from: function (d) {
                if (d.nodeType === wysihtml5.ELEMENT_NODE) {
                    ...
                    var k, l, m = e.defaultView || e.parentWindow, n = ("height" === c || "width" === c) && "TEXTAREA" === d.nodeName;
    ...
    function a(a, c) {
        ...
        var d, e, f, g = c.context || a.ownerDocument || document, h = g.createDocumentFragment(), i = "string" == typeof a, j = !1;
    ...
    function b(a, c, d) {
        var e, f, g, h = a.nodeType, i = a.childNodes, j = i.length, k = l[h], n = 0;
    ...
    function c(a, b) {
        var c, e, h = p.tags, i = a.nodeName.toLowerCase(), j = a.scopeName;
    ...
    function d(a, b, c, d) {
        ...
        for (g in c)if (c.hasOwnProperty(g) && b.type_definitions && b.type_definitions[g] && (f = b.type_definitions[g], e(a, f)))return !0;
        return !1
    }

    function e(a, b) {
        var c, d, e, f, g, i = a.getAttribute("class"), j = a.getAttribute("style");
        if (b.methods)for (var k in b.methods)if (b.methods.hasOwnProperty(k) && w[k] && w[k](a))return !0;
        if (i && b.classes) {
        ...
        if (j && b.styles) {
            j = j.split(";");
            for (d in b.styles)if (b.styles.hasOwnProperty(d))for (var m = j.length; m--;)if (g = j[m].split(":"), g[0].replace(/\s/g, "").toLowerCase() === d && (b.styles[d] === !0 || 1 === b.styles[d] || wysihtml5.lang.array(b.styles[d]).contains(g[1].replace(/\s/g, "").toLowerCase())))return !0
        }
        if (b.attrs)for (e in b.attrs)if (b.attrs.hasOwnProperty(e) && (f = h(a, e), "string" == typeof f && f.search(b.attrs[e]) > -1))return !0;
        return !1
    }
    ...
    function g(a, b, c, d) {
        var e, f, g, i, j, k, l, m = {}, o = c.set_class, q = c.add_class, r = c.add_style, s = c.set_attributes, w = c.check_attributes, x = p.classes, y = 0, z = [], A = [], B = [], C = [];
        if (s && (m = wysihtml5.lang.object(s).clone()), w)for (i in w)k = t[w[i]], k && (l = h(a, i), (l || "alt" === i && "IMG" == a.nodeName) && (j = k(l), "string" == typeof j && (m[i] = j)));
        if (o && z.push(o), q)for (i in q)k = v[q[i]], k && (g = k(h(a, i)), "string" == typeof g && z.push(g));
        if (r)for (i in r)k = u[r[i]], k && (newStyle = k(h(a, i)), "string" == typeof newStyle && A.push(newStyle));
        if ("string" == typeof x && "any" === x && a.getAttribute("class"))m["class"] = a.getAttribute("class"); else {
    ...
    var l = {1: c, 3: j, 8: k}, m = "span", n = /\s+/, o = {
        tags: {},
        classes: {}
    }, p = {}, q = !1, r = !wysihtml5.browser.supportsGetAttributeCorrectly(), s = /\uFEFF/g, t = {
        url: function () {
            var a = /^https?:\/\//i;
            return function (b) {
    ...
    a.dom.Sandbox = Base.extend({
        constructor: function (b, c) {
            ...
            if (a.dom.contains(b.documentElement, f)) {
                var g = this, h = f.contentWindow, i = f.contentWindow.document, j = b.characterSet || b.charset || "utf-8", k = this._getHtml({
                    charset: j,
    ...
    if (c && "outerHTML" in a) {
        var e = a.outerHTML.toLowerCase(), f = -1 != e.indexOf(" " + b + "=");
    ...
    return a.compareDocumentPosition ? function (a, b) {
        ...
        for (e = b, g = null; e;) {
            ...
            if (-1 !== h) {
                var i = f[h], j = wysihtml5.lang.array(i.childNodes).indexOf(f[h - 1]), k = wysihtml5.lang.array(i.childNodes).indexOf(g);
                return j > k ? 2 : 4
            }
            g = e, e = e.parentNode
        }
    ...
    function a(a, c, d) {
        ...
        var e, f, g, h, i, j, k = "string" == typeof a, l = 0;
        e = k ? wysihtml5.dom.getAsDom(a, d) : a;
        for (i in c)for (g = e.querySelectorAll(i), f = c[i], h = g.length; h > l; l++)f(g[l]);
    ...
    function e() {
        if (a) {
            ...
            if (b.length > 0)for (var c = 0; c < b.length; c++)k.removeClass(b[c], m)
        }
    }
    ...
    a.Selection = Base.extend({
        constructor: function (a, b, c) {
            ...
            var d, f, g, h, i, j, k, l, m = this.doc.body, n = c && m.scrollTop, o = c && m.scrollLeft, p = "_wysihtml5-temp-placeholder", q = '<span class="' + p + '">' + a.INVISIBLE_SPACE + "</span>", r = this.getRange(!0);
            ...
            var b = rangy.createRange(this.doc), c = b.createContextualFragment(a), d = c.lastChild;
    ...
    exec: function (a) {
        ...
        return b.selection.executeAndRestoreRangy(function () {
            for (var j = a.length; j--;)if (f = a[j], f.parentNode && (c = f.parentNode, "OL" === c.tagName || "UL" === c.tagName)) {
