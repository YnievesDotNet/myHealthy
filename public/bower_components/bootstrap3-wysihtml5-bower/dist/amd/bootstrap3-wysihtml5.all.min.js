...
define("wysihtml5", function (a) {
    var b = (a("jquery"), a("rangy"));
    ...
    !function (a, b) {
        ...
        function l() {
            if (!C.initialized) {
                ...
                C.initialized = !0, C.features = {implementsDomRange: c, implementsTextRange: d};
                var j, l;
        ...
        return typeof window == t ? void i("No window found") : typeof document == t ? void i("No document found") : (a(document, "addEventListener") && document.addEventListener("DOMContentLoaded", H, !1), D(window, "load", H), C.createCoreModule("DomUtil", [], function (a, b) {
            ...
            function D(a, b) {
                return function () {
                    y(this);
                    var c, d, f = this.startContainer, g = this.startOffset, h = this.commonAncestorContainer, j = new n(this, !0);
            ...
            function E(c, f) {
                ...
                l.prototype = a.rangePrototype, c.prototype = new l, J.extend(c.prototype, {
                    ...
                    normalizeBoundaries: function () {
                        y(this);
                        var a = this.startContainer, b = this.startOffset, c = this.endContainer, d = this.endOffset, e = function (a) {
                            var b = a.nextSibling;
                            ...
                            if (f && f.nodeType == e.nodeType) {
                                a = e;
                                var g = e.length;
                                if (b = f.length, e.insertData(0, f.data), f.parentNode.removeChild(f), a == c)d += b, c = a; else if (c == e.parentNode) {
                                    var h = N(e);
                                    d == h ? (c = e, d = g) : d > h && d--
                                }
                            }
                        }, h = !0;
                        if (M(c))c.length == d && e(c); else {
                            if (d > 0) {
                        ...
                        if (h) {
                            if (M(a))0 == b && g(a); else if (b < a.childNodes.length) {
            ...
            var I = a.dom, J = a.util, K = I.DomPosition, L = a.DOMException, M = I.isCharacterDataNode, N = I.getNodeIndex, O = I.isOrIsAncestorOf, P = I.getDocument, Q = I.comparePoints, R = I.splitDataNode, S = I.getClosestAncestorIn, T = I.getNodeLength, U = I.arrayContains, V = I.getRootContainer, W = a.features.crashyTextNodes;
            n.prototype = {
                _current: null,
                _next: null,
                _first: null,
            ...
            var X = [1, 3, 4, 5, 7, 8, 10], Y = [2, 9, 11], Z = [5, 6, 10, 12], $ = [1, 3, 4, 5, 7, 8, 10, 11], _ = [1, 3, 4, 5, 7, 8], ab = o([9, 11]), bb = o(Z), cb = o([6, 10, 12]), db = document.createElement("style"), eb = !1;
            try {
            ...
            }, hb = ["startContainer", "startOffset", "endContainer", "endOffset", "collapsed", "commonAncestorContainer"], ib = 0, jb = 1, kb = 2, lb = 3, mb = 0, nb = 1, ob = 2, pb = 3;
            J.extend(a.rangePrototype, {
                compareBoundaryPoints: function (a, b) {
                    y(this), s(this.startContainer, b.startContainer);
                    var c, d, e, f, g = a == lb || a == ib ? "start" : "end", h = a == jb || a == ib ? "start" : "end";
                ...
                }, createContextualFragment: gb, toHtml: function () {
                    return A(this)
                }, intersectsNode: function (a, b) {
                    if (y(this), u(a, "NOT_FOUND_ERR"), P(a) !== c(this))return !1;
                    var d = a.parentNode, e = N(a);
                    u(d, "NOT_FOUND_ERR");
                    var f = Q(d, e, this.endContainer, this.endOffset), g = Q(d, e + 1, this.startContainer, this.startOffset);
            ...
            var R = y(), S = a.createNativeRange(document), T = M(document), U = D.areHostProperties(R, ["anchorNode", "focusNode", "anchorOffset", "focusOffset"]);
            ...
            D.areHostMethods(R, ["addRange", "getRangeAt", "removeAllRanges"]) && typeof R.rangeCount == B && J.implementsDomRange && !function () {
                ...
                if (b) {
                    ...
                    var i = M(document), j = i.appendChild(document.createElement("div"));
                    j.contentEditable = "false";
                    var k = j.appendChild(document.createTextNode("   ")), l = document.createRange();
        ...
        a.createModule("SaveRestore", ["WrappedRange"], function (a, b) {
            ...
            function g(b, c) {
                var e, f, g = a.DomRange.getRangeDocument(b), h = b.toString();
    ...
    return e.extend = function (a, b) {
        var c = e.prototype.extend;
        e._prototyping = !0;
        var d = new this;
        c.call(d, a), d.base = function () {
        }, delete e._prototyping;
        var f = d.constructor, g = d.constructor = function () {
            if (!e._prototyping)if (this._constructing || this.constructor == g)this._constructing = !0, f.apply(this, arguments), delete this._constructing; else if (null != arguments[0])return (arguments[0].extend || c).call(arguments[0], d)
        };
        return g.ancestor = this, g.extend = this.extend, g.forEach = this.forEach, g.implement = this.implement, g.prototype = d, g.toString = this.toString, g.valueOf = function (a) {
            return "object" == a ? g : f.valueOf()
        }, c.call(g, b), "function" == typeof g.init && g.init(), g
    }, e.prototype = {
        extend: function (a, b) {
            if (arguments.length > 1) {
                ...
                if (c && "function" == typeof b && (!c.valueOf || c.valueOf() != b.valueOf()) && /\bbase\b/.test(b)) {
                    var d = b.valueOf();
                    b = function () {
                        var a = this.base || e.prototype.base;
                        this.base = c;
                ...
                var f = e.prototype.extend;
                e._prototyping || "function" == typeof this || (f = this.extend || f);
                for (var g = {toSource: null}, h = ["constructor", "toString", "valueOf"], i = e._prototyping ? 0 : 1; j = h[i++];)a[j] != g[j] && f.call(this, j, a[j]);
                for (var j in a)g[j] || f.call(this, j, a[j])
            }
            return this
        }
    }, e = e.extend({
    ...
    }(), d.lang.array = function (a) {
        return {
            contains: function (b) {
                if (Array.isArray(b)) {
                    for (var c = b.length; c--;)if (-1 !== d.lang.array(a).indexOf(b[c]))return !0;
                    return !1
                }
                return -1 !== d.lang.array(a).indexOf(b)
            }, indexOf: function (b) {
                ...
                b = d.lang.array(b);
                for (var c = [], e = 0, f = a.length; f > e; e++)b.contains(a[e]) || c.push(a[e]);
                return c
            }, get: function () {
                ...
                for (var b = [], c = a.length, e = 0; c > e;)d.lang.array(b).contains(a[e]) || b.push(a[e]), e++;
                return b
            }
        }
    }, d.lang.Dispatcher = e.extend({
        on: function (a, b) {
        ...
        var a = /^\s+/, b = /\s+$/, c = /[&<>"]/g, e = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;"};
        d.lang.string = function (d) {
            return d = String(d), {
                trim: function () {
                    return d.replace(a, "").replace(b, "")
                }, interpolate: function (a) {
                    for (var b in a)d = this.replace("#{" + b + "}").by(a[b]);
                    return d
                }, replace: function (a) {
                    return {
                        by: function (b) {
                            return d.split(a).join(b)
                        }
                    }
                }, escapeHTML: function () {
                    return d.replace(c, function (a) {
                        return e[a]
                    })
                }
            }
    ...
    }(d), d.dom.contains = function () {
        var a = document.documentElement;
        return a.contains ? function (a, b) {
            return b.nodeType !== d.ELEMENT_NODE && (b = b.parentNode), a !== b && a.contains(b)
        } : a.compareDocumentPosition ? function (a, b) {
            return !!(16 & a.compareDocumentPosition(b))
        } : void 0
    }(), d.dom.convertToList = function () {
        function a(a, b) {
        ...
        function c(c, e, f) {
            ...
            var g, h, i, j, k, l, m, n, o, p = c.ownerDocument, q = b(p, e), r = c.querySelectorAll("br"), s = r.length;
            for (o = 0; s > o; o++)for (j = r[o]; (k = j.parentNode) && k !== c && k.lastChild === j;) {
                if ("block" === d.dom.getStyle("display").from(k)) {
                    k.removeChild(j);
                    break
                }
                d.dom.insert(j).after(j.parentNode)
            }
            for (g = d.lang.array(c.childNodes).get(), h = g.length, o = 0; h > o; o++)n = n || a(p, q), i = g[o], l = "block" === d.dom.getStyle("display").from(i), m = "BR" === i.nodeName, !l || f && d.dom.hasClass(i, f) ? m ? n = n.firstChild ? null : n : n.appendChild(i) : (n = n.firstChild ? a(p, q) : n, n.appendChild(i), n = null);
            return 0 === g.length && a(p, q), c.parentNode.replaceChild(q, c), q
        }

        return c
    }(), d.dom.copyAttributes = function (a) {
        return {
            from: function (b) {
                return {
                    to: function (c) {
        ...
        a.copyStyles = function (e) {
            return {
                from: function (f) {
                    c(f) && (e = d.lang.array(e).without(b));
        ...
        return function (c, e) {
            e = e || document;
            var f;
            return "object" == typeof c && c.nodeType ? (f = e.createElement("div"), f.appendChild(c)) : d.browser.supportsHTML5Tags(e) ? (f = e.createElement("div"), f.innerHTML = c) : (b(e), f = a(c, e)), f
        }
    }(), d.dom.getParentElement = function () {
        function a(a, b) {
            return b && b.length ? "string" == typeof b ? a === b : d.lang.array(b).contains(a) : !0
        }

        function b(a) {
            return a.nodeType === d.ELEMENT_NODE
        }
        ...
        return function (d, f, g, h) {
            ...
            for (g = g || 50; g-- && d && "BODY" !== d.nodeName && (!h || d !== h);) {
                if (b(d) && a(d.nodeName, f.nodeName) && (!i || e(d, f.cssStyle, f.styleRegExp)) && (!j || c(d, f.className, f.classRegExp)))return d;
                d = d.parentNode
            }
            return null
        }
    }(), d.dom.getStyle = function () {
        function a(a) {
            ...
            return {
                from: function (e) {
                    if (e.nodeType === d.ELEMENT_NODE) {
                        var f = e.ownerDocument, g = b[c] || a(c), h = e.style, i = e.currentStyle, j = h[g];
                        if (j)return j;
                        if (i)try {
                            return i[g]
                        } catch (k) {
                        }
                        var l, m, n = f.defaultView || f.parentWindow, o = ("height" === c || "width" === c) && "TEXTAREA" === e.nodeName;
                        return n.getComputedStyle ? (o && (l = h.overflow, h.overflow = "hidden"), m = n.getComputedStyle(e, null).getPropertyValue(c), o && (h.overflow = l || ""), m) : void 0
                    }
                }
            }
        }
    }(), d.dom.getTextNodes = function (a, b) {
        var c = [];
        for (a = a.firstChild; a; a = a.nextSibling)3 == a.nodeType ? b && /^\s*$/.test(a.innerText || a.textContent) || c.push(a) : c = c.concat(d.dom.getTextNodes(a, b));
        return c
    }, d.dom.hasElementWithTagName = function () {
        function a(a) {
    ...
    }(d), d.dom.observe = function (a, b, c) {
    ...
    }, d.dom.parse = function () {
        function a(a, c) {
            d.lang.object(q).merge(p).merge(c.rules).get();
            var e, f, g, h = c.context || a.ownerDocument || document, i = h.createDocumentFragment(), j = "string" == typeof a, k = !1;
            for (c.clearInternals === !0 && (k = !0), c.uneditableClass && (r = c.uneditableClass), e = j ? d.dom.getAsDom(a, h) : a; e.firstChild;)g = e.firstChild, f = b(g, c.cleanUp, k), f && i.appendChild(f), g !== f && e.removeChild(g);
            return e.innerHTML = "", e.appendChild(i), j ? d.quirks.getCorrectInnerHTML(e) : e
        }

        function b(a, c, e) {
            var f, g, h, i = a.nodeType, j = a.childNodes, k = j.length, l = m[i], o = 0;
            if (r && 1 === i && d.dom.hasClass(a, r))return a;
            if (g = l && l(a, e), !g) {
                if (g === !1) {
                    for (f = a.ownerDocument.createDocumentFragment(), o = k; o--;)j[o] && (h = b(j[o], c, e), h && (j[o] === h && o--, f.insertBefore(h, f.firstChild)));
                    return d.lang.array(["div", "pre", "p", "table", "td", "th", "ul", "ol", "li", "dd", "dl", "footer", "header", "section", "h1", "h2", "h3", "h4", "h5", "h6"]).contains(a.nodeName.toLowerCase()) && a.parentNode.lastChild !== a && (a.nextSibling && 3 === a.nextSibling.nodeType && /^\s/.test(a.nextSibling.nodeValue) || f.appendChild(a.ownerDocument.createTextNode(" "))), f.normalize && f.normalize(), f
                }
                return null
            }
            for (o = 0; k > o; o++)j[o] && (h = b(j[o], c, e), h && (j[o] === h && o--, g.appendChild(h)));
            if (c && g.nodeName.toLowerCase() === n && (!g.childNodes.length || /^\s*$/gi.test(g.innerHTML) && (e || "_wysihtml5-temp-placeholder" !== a.className && "rangySelectionBoundary" !== a.className) || !g.attributes.length)) {
        ...
        function c(a, b) {
            var c, f, i = q.tags, j = a.nodeName.toLowerCase(), k = a.scopeName;
            if (a._wysihtml5)return null;
            if (a._wysihtml5 = 1, "wysihtml5-temp" === a.className)return null;
            if (k && "HTML" != k && (j = k + ":" + j), "outerHTML" in a && (d.browser.autoClosesUnclosedTags() || "P" !== a.nodeName || "</p>" === a.outerHTML.slice(-4).toLowerCase() || (j = "div")), j in i) {
                if (c = i[j], !c || c.remove)return null;
            ...
            return f = a.ownerDocument.createElement(c.rename_tag || j), h(a, f, c, b), g(a, f, c), c.one_of_type && !e(a, q, c.one_of_type, b) ? c.remove_action && "unwrap" == c.remove_action ? !1 : null : (a = null, f.normalize && f.normalize(), f)
        }

        function e(a, b, c, d) {
            var e, g;
            if ("SPAN" === a.nodeName && !d && ("_wysihtml5-temp-placeholder" === a.className || "rangySelectionBoundary" === a.className))return !0;
            for (g in c)if (c.hasOwnProperty(g) && b.type_definitions && b.type_definitions[g] && (e = b.type_definitions[g], f(a, e)))return !0;
            return !1
        }

        function f(a, b) {
            var c, e, f, g, h, j = a.getAttribute("class"), k = a.getAttribute("style");
            if (b.methods)for (var l in b.methods)if (b.methods.hasOwnProperty(l) && x[l] && x[l](a))return !0;
            if (j && b.classes) {
                j = j.replace(/^\s+/g, "").replace(/\s+$/g, "").split(o), c = j.length;
                for (var m = 0; c > m; m++)if (b.classes[j[m]])return !0
            }
            if (k && b.styles) {
                k = k.split(";");
                for (e in b.styles)if (b.styles.hasOwnProperty(e))for (var n = k.length; n--;)if (h = k[n].split(":"), h[0].replace(/\s/g, "").toLowerCase() === e && (b.styles[e] === !0 || 1 === b.styles[e] || d.lang.array(b.styles[e]).contains(h[1].replace(/\s/g, "").toLowerCase())))return !0
            }
            if (b.attrs)for (f in b.attrs)if (b.attrs.hasOwnProperty(f) && (g = i(a, f), "string" == typeof g && g.search(b.attrs[f]) > -1))return !0;
            return !1
        }

        function g(a, b, c) {
            var d;
            if (c && c.keep_styles)for (d in c.keep_styles)c.keep_styles.hasOwnProperty(d) && ("float" == d ? (a.style.styleFloat && (b.style.styleFloat = a.style.styleFloat), a.style.cssFloat && (b.style.cssFloat = a.style.cssFloat)) : a.style[d] && (b.style[d] = a.style[d]))
        }

        function h(a, b, c, e) {
            var f, g, h, j, k, l, m, n = {}, p = c.set_class, r = c.add_class, s = c.add_style, t = c.set_attributes, x = c.check_attributes, y = q.classes, z = 0, A = [], B = [], C = [], D = [];
            if (t && (n = d.lang.object(t).clone()), x)for (j in x)l = u[x[j]], l && (m = i(a, j), (m || "alt" === j && "IMG" == a.nodeName) && (k = l(m), "string" == typeof k && (n[j] = k)));
            if (p && A.push(p), r)for (j in r)l = w[r[j]], l && (h = l(i(a, j)), "string" == typeof h && A.push(h));
            if (s)for (j in s)l = v[s[j]], l && (newStyle = l(i(a, j)), "string" == typeof newStyle && B.push(newStyle));
            if ("string" == typeof y && "any" === y && a.getAttribute("class"))n["class"] = a.getAttribute("class"); else {
                for (e || (y["_wysihtml5-temp-placeholder"] = 1, y._rangySelectionBoundary = 1, y["wysiwyg-tmp-selected-cell"] = 1), D = a.getAttribute("class"), D && (A = A.concat(D.split(o))), f = A.length; f > z; z++)g = A[z], y[g] && C.push(g);
                C.length && (n["class"] = d.lang.array(C).unique().join(" "))
            }
            n["class"] && e && (n["class"] = n["class"].replace("wysiwyg-tmp-selected-cell", ""), /^\s*$/g.test(n["class"]) && delete n["class"]), B.length && (n.style = d.lang.array(B).unique().join(" "));
            for (j in n)try {
                b.setAttribute(j, n[j])
            } catch (E) {
            }
            n.src && ("undefined" != typeof n.width && b.setAttribute("width", n.width), "undefined" != typeof n.height && b.setAttribute("height", n.height))
        }

        function i(a, b) {
            b = b.toLowerCase();
            var c = a.nodeName;
            if ("IMG" == c && "src" == b && j(a) === !0)return a.src;
            if (s && "outerHTML" in a) {
                var d = a.outerHTML.toLowerCase(), e = -1 != d.indexOf(" " + b + "=");
        ...
        function k(a) {
            var b = a.nextSibling;
            if (!b || b.nodeType !== d.TEXT_NODE) {
                var c = a.data.replace(t, "");
                return a.ownerDocument.createTextNode(c)
            }
            b.data = a.data.replace(t, "") + b.data.replace(t, "")
        }

        function l(a) {
            return q.comments ? a.ownerDocument.createComment(a.nodeValue) : void 0
        }

        var m = {1: c, 3: k, 8: l}, n = "span", o = /\s+/, p = {
            tags: {},
            classes: {}
        }, q = {}, r = !1, s = !d.browser.supportsGetAttributeCorrectly(), t = /\uFEFF/g, u = {
            url: function () {
                var a = /^https?:\/\//i;
                return function (b) {
        ...
        return a
    }(), d.dom.removeEmptyTextNodes = function (a) {
        for (var b, c = d.lang.array(a.childNodes).get(), e = c.length, f = 0; e > f; f++)b = c[f], b.nodeType === d.TEXT_NODE && "" === b.data && b.parentNode.removeChild(b)
    }, d.dom.renameElement = function (a, b) {
        for (var c, e = a.ownerDocument.createElement(b); c = a.firstChild;)e.appendChild(c);
        return d.dom.copyAttributes(["align", "className"]).from(a).to(e), a.parentNode.replaceChild(e, a), e
    }, d.dom.replaceWithChildNodes = function (a) {
        if (a.parentNode) {
        ...
        function f(a, f) {
            if (a.nodeName.match(/^(MENU|UL|OL)$/)) {
                var g, h, i, j, k, l, m = a.ownerDocument, n = m.createDocumentFragment(), o = d.dom.domNode(a).prev({ignoreBlankTexts: !0});
                if (f)for (!o || b(o) || c(o) || e(n); l = a.firstElementChild || a.firstChild;) {
                    for (h = l.lastChild; g = l.firstChild;)i = g === h, j = i && !b(g) && !c(g), n.appendChild(g), j && e(n);
        ...
        var b = document, c = ["parent", "top", "opener", "frameElement", "frames", "localStorage", "globalStorage", "sessionStorage", "indexedDB"], d = ["open", "close", "openDialog", "showModalDialog", "alert", "confirm", "prompt", "openDatabase", "postMessage", "XMLHttpRequest", "XDomainRequest"], f = ["referrer", "write", "open", "close"];
        a.dom.Sandbox = e.extend({
            ...
            }, _onLoadIframe: function (e) {
                if (a.dom.contains(b.documentElement, e)) {
                    var g = this, h = e.contentWindow, i = e.contentWindow.document, j = b.characterSet || b.charset || "utf-8", k = this._getHtml({
                        charset: j,
        ...
        var b = document;
        a.dom.ContentEditableArea = e.extend({
        ...
        d.dom.setAttributes = function (b) {
            return {
                on: function (c) {
    ...
    }(d.dom), d.dom.getAttribute = function (a, b) {
        var c = !d.browser.supportsGetAttributeCorrectly();
        b = b.toLowerCase();
        var e = a.nodeName;
        if ("IMG" == e && "src" == b && _isLoadedImage(a) === !0)return a.src;
        if (c && "outerHTML" in a) {
            var f = a.outerHTML.toLowerCase(), g = -1 != f.indexOf(" " + b + "=");
            return g ? a.getAttribute(b) : null
        }
        return a.getAttribute(b)
    }, function (a) {
        function b(a, b) {
            for (var c, d = [], e = 0, f = a.length; f > e; e++)if (c = a[e].querySelectorAll(b))for (var g = c.length; g--; d.unshift(c[g]));
            return d
        }
        ...
        i.prototype = {
            addSpannedCellToMap: function (a, b, c, d, e, f) {
                ...
                for (a = 0; a < l.length; a++)for (b = l[a], c = this.getRowCells(b), f = 0, "undefined" == typeof k[a] && (k[a] = []), d = 0; d < c.length; d++) {
                ...
                for (var b = this.map.length, c = this.map && this.map[0] ? this.map[0].length : 0, d = 0; b > d; d++)for (var e = 0; c > e; e++)if (this.map[d][e].el === a)return {
                    row: d,
                    col: e
                };
                return !1
                ...
                if (null != this.idx_start && null != this.idx_end)for (var e = this.idx_start.row, f = this.idx_end.row; f >= e; e++)for (var g = this.idx_start.col, h = this.idx_end.col; h >= g; g++)b.push(this.map[e][g].el);
                return b
                ...
                for (var c, d, e = this.getRowCells(a), f = 0, g = e.length; g > f; f++)if (c = e[f], d = this.getMapIndex(c), d === !1 || "undefined" != typeof b && d.row != b)return c;
                return null
                ...
                if (a.isColspan) {
                    var b = parseInt(g.getAttribute(a.el, "colspan") || 1, 10), c = a.el.tagName.toLowerCase();
                    if (b > 1) {
                ...
                var c = null, d = null;
                b = b || this.idx;
                for (var e = 0, f = this.map[b.row].length; f > e; e++)if (d = this.map[b.row][e], d.isReal && (c = g.getParentElement(d.el, {nodeName: ["TR"]})))return c;
                return null === c && a && (c = g.getParentElement(this.map[b.row][b.col].el, {nodeName: ["TR"]}) || null), c
            }, injectRowAt: function (a, b, c, d, f) {
                var h = this.getRealRowEl(!1, {row: a, col: b}), i = this.createCells(d, c);
                if (h) {
                ...
                for (var d = this.idx_start.row, e = this.idx_end.row; e >= d; d++)for (var f = this.idx_start.col, g = this.idx_end.col; g >= f; f++)if (this.map[d][f].isColspan || this.map[d][f].isRowspan)return !1;
                return !0
                ...
                if (this.setTableMap(), this.map) {
                    ...
                    for (var f = 0; a > f; f++)for (var g = 0; b > g; g++)this.map[f] && !this.map[f][g] && g > 0 && (this.map[f][g] = new h(this.createCells("td", 1)), c = this.map[f][g - 1], c && c.el && c.el.parent && e(this.map[f][g - 1].el, this.map[f][g].el))
                }
            }, rectify: function () {
                ...
                if (this.rectify() && (this.setTableMap(), this.idx = this.getMapIndex(this.cell), this.idx)) {
                    var a = this.map[this.idx.row][this.idx.col], b = g.getAttribute(a.el, "colspan") ? parseInt(g.getAttribute(a.el, "colspan"), 10) : 1, c = a.el.tagName.toLowerCase();
                    if (a.isRowspan) {
                        var d = parseInt(g.getAttribute(a.el, "rowspan"), 10);
                        if (d > 1)for (var e = 1, f = d - 1; f >= e; e++)this.injectRowAt(this.idx.row + e, this.idx.col, b, c, a);
                ...
                var a = [];
                if (this.setTableMap(), this.idx = this.getMapIndex(this.cell), this.idx !== !1)for (var b = this.map[this.idx.row], c = 0, d = b.length; d > c; c++)b[c].isReal && a.push(b[c].el);
                return a
            }, getColumnElementsByCell: function () {
                var a = [];
                if (this.setTableMap(), this.idx = this.getMapIndex(this.cell), this.idx !== !1)for (var b = 0, c = this.map.length; c > b; b++)this.map[b][this.idx.col] && this.map[b][this.idx.col].isReal && a.push(this.map[b][this.idx.col].el);
                return a
            }, removeRow: function () {
                var a = g.getParentElement(this.cell, {nodeName: ["TR"]});
                if (a) {
                    if (this.setTableMap(), this.idx = this.getMapIndex(this.cell), this.idx !== !1)for (var b = this.map[this.idx.row], c = 0, e = b.length; e > c; c++)b[c].modified || (this.setCellAsModified(b[c]), this.removeRowCell(b[c]));
                    d(a)
                }
                ...
                if (this.setTableMap(), this.idx = this.getMapIndex(this.cell), "below" == a && g.getAttribute(this.cell, "rowspan") && (this.idx.row = this.idx.row + parseInt(g.getAttribute(this.cell, "rowspan"), 10) - 1), this.idx !== !1) {
                    ...
                    switch (a) {
                        case"below":
                            ...
                            break;
                        case"above":
                            var i = g.getParentElement(this.map[this.idx.row][this.idx.col].el, {nodeName: ["TR"]});
                ...
                var b, c;
                if (this.setTableMap(), this.idx = this.getMapIndex(this.cell), "after" == a && g.getAttribute(this.cell, "colspan") && (this.idx.col = this.idx.col + parseInt(g.getAttribute(this.cell, "colspan"), 10) - 1), this.idx !== !1)for (var d = 0, e = this.map.length; e > d; d++)b = this.map[d], b[this.idx.col] && (c = b[this.idx.col], c.modified || (this.setCellAsModified(c), this.addColCell(c, d, a)))
            }, handleCellAddWithRowspan: function (a, b, c) {
                for (var d, h, i, j = parseInt(g.getAttribute(this.cell, "rowspan"), 10) - 1, k = g.getParentElement(a.el, {nodeName: ["TR"]}), l = a.el.tagName.toLowerCase(), m = this.table.ownerDocument, n = 0; j > n; n++)if (d = this.correctColIndexForUnreals(this.idx.col, b + n), k = f(k, "tr"))if (d > 0)switch (c) {
                    case"before":
                ...
                } else k.insertBefore(this.createCells(l, 1), k.firstChild); else i = m.createElement("tr"), i.appendChild(this.createCells(l, 1)), this.table.appendChild(i)
            }
        }, g.table = {
    ...
    }(d), d.dom.query = function (a, b) {
        var c, d = [];
        a.nodeType && (a = [a]);
        for (var e = 0, f = a.length; f > e; e++)if (c = a[e].querySelectorAll(b))for (var g = c.length; g--; d.unshift(c[g]));
        return d
        ...
        return a.compareDocumentPosition ? function (a, b) {
            ...
            var c, e;
            if (c = 9 === a.nodeType ? a : a.ownerDocument, e = 9 === b.nodeType ? b : b.ownerDocument, a === b)return 0;
            if (a === b.ownerDocument)return 20;
            if (a.ownerDocument === b)return 10;
            if (c !== e)return 1;
            if (2 === a.nodeType && a.childNodes && -1 !== d.lang.array(a.childNodes).indexOf(b))return 20;
            if (2 === b.nodeType && b.childNodes && -1 !== d.lang.array(b.childNodes).indexOf(a))return 10;
            for (var f = a, g = [], h = null; f;) {
                if (f == b)return 10;
                g.push(f), f = f.parentNode
            }
            for (f = b, h = null; f;) {
                if (f == a)return 20;
                var i = d.lang.array(g).indexOf(f);
                if (-1 !== i) {
                    var j = g[i], k = d.lang.array(j.childNodes).indexOf(g[i - 1]), l = d.lang.array(j.childNodes).indexOf(h);
                    return k > l ? 2 : 4
                }
                h = f, f = f.parentNode
            }
    ...
    }(), d.dom.unwrap = function (a) {
        if (a.parentNode) {
            for (; a.lastChild;)d.dom.insert(a.lastChild).after(a);
            a.parentNode.removeChild(a)
        }
    }, d.quirks.cleanPastedHTML = function () {
        function a(a, c, e) {
            c = c || b, e = e || a.ownerDocument || document;
            var f, g, h, i, j, k, l = "string" == typeof a, m = 0;
            f = l ? d.dom.getAsDom(a, e) : a;
            for (j in c)for (h = f.querySelectorAll(j), g = c[j], i = h.length; i > m; m++)g(h[m]);
            var n = d.dom.getTextNodes(f);
            for (k = n.length; k--;)n[k].nodeValue = n[k].nodeValue.replace(/([\S\u00A0])\u00A0/gi, "$1 ");
            return h = a = c = null, l ? f.innerHTML : f
        }

        var b = {"a u": d.dom.replaceWithChildNodes};
        return a
    }(), d.quirks.ensureProperClearing = function () {
        var a = function () {
            var a = this;
            setTimeout(function () {
        ...
        return function (b) {
            d.dom.observe(b.element, ["cut", "keydown"], a)
        }
    }(), function (a) {
        var b = "%7E";
    ...
    }(d), d.quirks.tableCellsSelection = function (a, b) {
        function c() {
            return l.observe(a, "mousedown", function (a) {
                var b = d.dom.getParentElement(a.target, {nodeName: ["TD", "TH"]});
                b && e(b)
            }), m
        }

        function e(c) {
            m.start = c, m.end = c, m.cells = [c], m.table = l.getParentElement(m.start, {nodeName: ["TABLE"]}), m.table && (f(), l.addClass(c, n), o = l.observe(a, "mousemove", h), p = l.observe(a, "mouseup", i), b.fire("tableselectstart").fire("tableselectstart:composer"))
        }

        function f() {
            if (a) {
                var b = a.querySelectorAll("." + n);
                if (b.length > 0)for (var c = 0; c < b.length; c++)l.removeClass(b[c], n)
            }
        }
        ...
        function h(a) {
            var c, d = null, e = l.getParentElement(a.target, {nodeName: ["TD", "TH"]});
            e && m.table && m.start && (d = l.getParentElement(e, {nodeName: ["TABLE"]}), d && d === m.table && (f(), c = m.end, m.end = e, m.cells = l.table.getCellsBetween(m.start, e), m.cells.length > 1 && b.composer.selection.deselect(), g(m.cells), m.end !== c && b.fire("tableselectchange").fire("tableselectchange:composer")))
        }

        function i() {
            o.stop(), p.stop(), b.fire("tableselect").fire("tableselect:composer"), setTimeout(function () {
                j()
            }, 0)
        }

        function j() {
            var c = l.observe(a.ownerDocument, "click", function (a) {
                c.stop(), l.getParentElement(a.target, {nodeName: ["TABLE"]}) != m.table && (f(), m.table = null, m.start = null, m.end = null, b.fire("tableunselect").fire("tableunselect:composer"))
            })
        }

        function k(a, c) {
            m.start = a, m.end = c, m.table = l.getParentElement(m.start, {nodeName: ["TABLE"]}), selectedCells = l.table.getCellsBetween(m.start, m.end), g(selectedCells), j(), b.fire("tableselect").fire("tableselect:composer")
        }
        ...
        a.quirks.styleParser = {
            parseColor: function (g, h) {
                var i, j, k = f(h), l = g.match(k), m = 10;
                if (l) {
                    for (var n = l.length; n--;)l[n] = a.lang.string(l[n].split(":")[1]).trim();
                    if (i = l[l.length - 1], b.test(i))j = i.match(b); else if (c.test(i))j = i.match(c); else if (d.test(i))j = i.match(d), m = 16; else if (e.test(i))return j = i.match(e), j.shift(), j.push(1), a.lang.array(j).map(function (a, b) {
        ...
        function f(a) {
            if (!a.canSurroundContents())for (var b = a.commonAncestorContainer, c = d(b, a.startContainer), e = d(b, a.endContainer); !a.canSurroundContents();)c > e ? (a.setStartBefore(a.startContainer), c = d(b, a.startContainer)) : (a.setEndAfter(a.endContainer), e = d(b, a.endContainer))
        }

        var g = a.dom;
        a.Selection = e.extend({
            constructor: function (a, b, c) {
                ...
                var c = b.createRange(this.doc);
                return c.setStartBefore(a), c.setEndBefore(a), this.setSelection(c)
            }, setAfter: function (a) {
                var c = b.createRange(this.doc);
                return c.setStartAfter(a), c.setEndAfter(a), this.setSelection(c)
            }, selectNode: function (c, d) {
                var e = b.createRange(this.doc), f = c.nodeType === a.ELEMENT_NODE, h = "canHaveHTML" in c ? c.canHaveHTML : "IMG" !== c.nodeName, i = f ? c.innerHTML : c.data, j = "" === i || i === a.INVISIBLE_SPACE, k = g.getStyle("display").from(c), l = "block" === k || "list-item" === k;
                if (j && f && h && !d)try {
                ...
                for (var a = this.getOwnUneditables(), b = this.getSelection(), c = 0, d = a.length; d > c; c++)if (b.containsNode(a[c]))return !0;
                return !1
                ...
                for (var b, c = this.getSelectedOwnNodes(), d = [], e = 0, f = c.length; f > e; e++)b = c[e].nodeName && "LI" === c[e].nodeName ? c[e] : a.dom.getParentElement(c[e], {nodeName: ["LI"]}, !1, this.contain), b && d.push(b);
                return d.length ? d : null
            }, getRangeToNodeEnd: function () {
                if (this.isCollapsed()) {
                    var a = this.getRange(), c = a.startContainer, d = a.startOffset, e = b.createRange(this.doc);
                    return e.selectNodeContents(c), e.setStart(c, d), e
                }
            }, caretIsLastInSelection: function () {
                var a = (b.createRange(this.doc), this.getSelection(), this.getRangeToNodeEnd().cloneContents()), c = a.textContent;
                return /^\s*$/.test(c)
            }, caretIsFirstInSelection: function () {
                var c = b.createRange(this.doc), d = this.getSelection(), e = this.getRange(), f = e.startContainer;
                return f.nodeType === a.TEXT_NODE ? this.isCollapsed() && f.nodeType === a.TEXT_NODE && /^\s*$/.test(f.data.substr(0, e.startOffset)) : (c.selectNodeContents(this.getRange().commonAncestorContainer), c.collapse(!0), this.isCollapsed() && (c.startContainer === d.anchorNode || c.endContainer === d.anchorNode) && c.startOffset === d.anchorOffset)
                ...
                var a = this.getSelection(), b = a.anchorNode, c = a.anchorOffset;
                if (0 === c) {
                    var d = this.getPreviousNode(b, !0);
                    if (d)for (var e = this.getOwnUneditables(), f = 0, g = e.length; g > f; f++)if (d === e[f])return e[f]
                }
                return !1
            }, executeAndRestoreRangy: function (a) {
                var c = this.doc.defaultView || this.doc.parentWindow, d = b.saveSelection(c);
                if (d)try {
                    a()
                } catch (e) {
                    setTimeout(function () {
                ...
                b.restoreSelection(d)
            }, executeAndRestore: function (c, d) {
                var e, f, h, i, j, k, l, m, n = this.doc.body, o = d && n.scrollTop, p = d && n.scrollLeft, q = "_wysihtml5-temp-placeholder", r = '<span class="' + q + '">' + a.INVISIBLE_SPACE + "</span>", s = this.getRange(!0);
                if (!s)return void c(n, n);
                s.collapsed || (l = s.cloneRange(), k = l.createContextualFragment(r), l.collapse(!1), l.insertNode(k), l.detach()), j = s.createContextualFragment(r), s.insertNode(j), k && (e = this.contain.querySelectorAll("." + q), s.setStartBefore(e[0]), s.setEndAfter(e[e.length - 1])), this.setSelection(s);
                try {
                    c(s.startContainer, s.endContainer)
                } catch (t) {
                    setTimeout(function () {
                        throw t
                    }, 0)
                }
                if (e = this.contain.querySelectorAll("." + q), e && e.length) {
                    m = b.createRange(this.doc), h = e[0].nextSibling, e.length > 1 && (i = e[e.length - 1].previousSibling), i && h ? (m.setStartBefore(h), m.setEndAfter(i)) : (f = this.doc.createTextNode(a.INVISIBLE_SPACE), g.insert(f).after(e[0]), m.setStartBefore(f), m.setEndAfter(f)), this.setSelection(m);
                    for (var u = e.length; u--;)e[u].parentNode.removeChild(e[u])
                } else this.contain.focus();
                d && (n.scrollTop = o, n.scrollLeft = p);
                try {
                    e.parentNode.removeChild(e)
                } catch (v) {
                }
            }, set: function (a, c) {
                var d = b.createRange(this.doc);
                d.setStart(a, c || 0), this.setSelection(d)
            }, insertHTML: function (a) {
                var c = b.createRange(this.doc), d = c.createContextualFragment(a), e = d.lastChild;
                this.insertNode(d), e && this.setAfter(e)
            }, insertNode: function (a) {
                var b = this.getRange();
                b && b.insertNode(a)
            }, surround: function (a) {
                var b, c = this.getOwnRanges(), d = [];
                ...
                var d, e, f, g = this.doc.createElement("div"), h = b.createRange(this.doc);
                if (g.className = c.className, this.composer.commands.exec("formatBlock", c.nodeName, c.className), d = this.contain.querySelectorAll("." + c.className), d[0])for (d[0].parentNode.insertBefore(g, d[0]), h.setStartBefore(d[0]), h.setEndAfter(d[d.length - 1]), e = h.extractContents(); e.firstChild;)if (f = e.firstChild, 1 == f.nodeType && a.dom.hasClass(f, c.className)) {
                ...
                var b, d = this.doc, e = 5, f = d.documentElement.scrollHeight > d.documentElement.offsetHeight, g = d._wysihtml5ScrollIntoViewElement = d._wysihtml5ScrollIntoViewElement || function () {
                        var b = d.createElement("span");
                        return b.innerHTML = a.INVISIBLE_SPACE, b
                    }();
                f && (this.insertNode(g), b = c(g), g.parentNode.removeChild(g), b >= d.body.scrollTop + d.documentElement.offsetHeight - e && (d.body.scrollTop = b))
            }, selectLine: function () {
                ...
                if (this.contain && this.contain.firstChild && a) {
                    ...
                    if (2 !== b)1 === b && a.setStartBefore(this.contain.firstChild), 0 === b && a.setEndAfter(this.contain.lastChild), 3 === b && (a.setStartBefore(this.contain.firstChild), a.setEndAfter(this.contain.lastChild)); else if (this._detectInlineRangeProblems(a)) {
                ...
                var b = g.query(this.contain, "." + this.unselectableClass), c = g.query(b, "." + this.unselectableClass);
                return a.lang.array(b).without(c)
            }, getOwnRanges: function () {
                var a, b = [], c = this.getRange();
                if (c && b.push(c), this.unselectableClass && this.contain && c) {
                    var d, e = this.getOwnUneditables();
                    if (e.length > 0)for (var f = 0, g = e.length; g > f; f++) {
                        a = [];
                ...
                return b.getSelection(this.doc.defaultView || this.doc.parentWindow)
            }, setSelection: function (a) {
                var c = this.doc.defaultView || this.doc.parentWindow, d = b.getSelection(c);
                return d.setSingleRange(a)
            }, createRange: function () {
                return b.createRange(this.doc)
        ...
        function i(a, b) {
            var c = [], d = b.split(";"), e = a.getAttribute("style");
            if (e) {
        ...
        r.prototype = {
            ...
            getAncestorWithClass: function (d) {
                ...
                var c = a.parentNode;
                if (1 == c.childNodes.length && b.dom.arrayContains(this.tagNames, c.tagName.toLowerCase()))this.cssClass && f(c, this.cssClass, this.similarClassRegExp), this.cssStyle && e(c, this.cssStyle, this.similarStyleRegExp); else {
                ...
                for (var c, d, e, f = b.length; f--;) {
                    if (c = b[f].getNodes([a.TEXT_NODE]), c.length)b[f].splitBoundaries(), c = b[f].getNodes([a.TEXT_NODE]); else {
                        var g = b[f].endContainer.ownerDocument, h = g.createTextNode(a.INVISIBLE_SPACE);
                ...
                return e.length ? {elements: e, coverage: f} : !1
    ...
    }(d, b), d.Commands = e.extend({
        constructor: function (a) {
            this.editor = a, this.composer = a.composer, this.doc = this.composer.doc
        }, support: function (a) {
            return d.browser.supportsCommand(this.doc, a)
        }, exec: function (a, b) {
            var c = d.commands[a], e = d.lang.array(arguments).get(), f = c && c.exec, g = null;
            if (this.editor.fire("beforecommand:composer"), f)e.unshift(this.composer), g = f.apply(c, e); else try {
                g = this.doc.execCommand(a, !1, b)
            } catch (h) {
            }
            return this.editor.fire("aftercommand:composer"), g
        }, state: function (a) {
            var b = d.commands[a], c = d.lang.array(arguments).get(), e = b && b.state;
            if (e)return c.unshift(this.composer), e.apply(b, c);
            try {
            ...
            var b = d.commands[a], c = d.lang.array(arguments).get(), e = b && b.stateValue;
            return e ? (c.unshift(this.composer), e.apply(b, c)) : !1
        }
    }), d.commands.bold = {
        exec: function (a, b) {
            d.commands.formatInline.execWithToggle(a, b, "b")
        }, state: function (a, b) {
            return d.commands.formatInline.state(a, b, "b")
        }
    }, function (a) {
        function b(b, c) {
        ...
        a.commands.formatBlock = {
            exec: function (f, g, m, n, o, p, q) {
                ...
                }), !t)) && h(f, {nodeName: m || y, className: n || null, cssStyle: p || null}))
            }, state: function (b, c, d, e, f, g, h) {
                var i, j = b.selection.getSelectedOwnNodes(), l = [];
    ...
    }(d), d.commands.formatCode = {
        exec: function (a, b, c) {
            var e, f, g, h = this.state(a);
            h ? a.selection.executeAndRestore(function () {
                e = h.querySelector("code"), d.dom.replaceWithChildNodes(h), e && d.dom.replaceWithChildNodes(e)
            }) : (f = a.selection.getRange(), g = f.extractContents(), h = a.doc.createElement("pre"), e = a.doc.createElement("code"), c && (e.className = c), h.appendChild(e), e.appendChild(g), f.insertNode(h), a.selection.selectNode(h))
        }, state: function (a) {
            var b = a.selection.getSelectedNode();
            return b && b.nodeName && "PRE" == b.nodeName && b.firstChild && b.firstChild.nodeName && "CODE" == b.firstChild.nodeName ? b : d.dom.getParentElement(b, {nodeName: "CODE"}) && d.dom.getParentElement(b, {nodeName: "PRE"})
        }
    }, function (a) {
        function b(a) {
            var b = d[a];
        ...
        a.commands.insertImage = {
            exec: function (c, d, e) {
                ...
                var f, g, h = c.doc, i = this.state(c);
    ...
    }(d), d.commands.insertOrderedList = {
        exec: function (a, b) {
            d.commands.insertList.exec(a, b, "OL")
        }, state: function (a, b) {
            return d.commands.insertList.state(a, b, "OL")
        }
    }, d.commands.insertUnorderedList = {
        exec: function (a, b) {
            d.commands.insertList.exec(a, b, "UL")
        }, state: function (a, b) {
            return d.commands.insertList.state(a, b, "UL")
        }
    }, d.commands.insertList = function (a) {
        var b = function (a, b) {
            if (a && a.nodeName) {
                "string" == typeof b && (b = [b]);
            ...
            if (c) {
                var g = a.dom.getParentElement(c, {nodeName: "LI"}), h = "UL" === d ? "OL" : "UL";
            ...
            d.selection.executeAndRestore(function () {
                var h = f(g, d);
                if (h.length)for (var i = h.length; i--;)a.dom.renameElement(h[i], c.toLowerCase()); else {
                    e = f(["OL", "UL"], d);
        ...
        exec: function (a, b) {
            d.commands.formatInline.execWithToggle(a, b, "i")
        }, state: function (a, b) {
            return d.commands.formatInline.state(a, b, "i")
        }
    }, function (a) {
    ...
    }, d.commands.underline = {
        exec: function (a, b) {
            d.commands.formatInline.execWithToggle(a, b, "u")
        }, state: function (a, b) {
            return d.commands.formatInline.state(a, b, "u")
        }
    }, d.commands.undo = {
        exec: function (a) {
    ...
    }, d.commands.mergeTableCells = {
        exec: function (a, b) {
            a.tableSelection && a.tableSelection.start && a.tableSelection.end && (this.state(a, b) ? d.dom.table.unmergeCell(a.tableSelection.start) : d.dom.table.mergeCellsBetween(a.tableSelection.start, a.tableSelection.end))
        }, state: function (a) {
            if (a.tableSelection) {
                var b = a.tableSelection.start, c = a.tableSelection.end;
                if (b && c && b == c && (d.dom.getAttribute(b, "colspan") && parseInt(d.dom.getAttribute(b, "colspan"), 10) > 1 || d.dom.getAttribute(b, "rowspan") && parseInt(d.dom.getAttribute(b, "rowspan"), 10) > 1))return [b]
            }
            return !1
        }
    }, d.commands.addTableCells = {
        exec: function (a, b, c) {
            if (a.tableSelection && a.tableSelection.start && a.tableSelection.end) {
                var e = d.dom.table.orderSelectionEnds(a.tableSelection.start, a.tableSelection.end);
                "before" == c || "above" == c ? d.dom.table.addCells(e.start, c) : ("after" == c || "below" == c) && d.dom.table.addCells(e.end, c), setTimeout(function () {
    ...
    }, d.commands.deleteTableCells = {
        exec: function (a, b, c) {
            if (a.tableSelection && a.tableSelection.start && a.tableSelection.end) {
                var e, f = d.dom.table.orderSelectionEnds(a.tableSelection.start, a.tableSelection.end), g = d.dom.table.indexOf(f.start), h = a.tableSelection.table;
                d.dom.table.removeCells(f.start, c), setTimeout(function () {
                    e = d.dom.table.findCell(h, g), e || ("row" == c && (e = d.dom.table.findCell(h, {
                        row: g.row - 1,
                        col: g.col
                    })), "column" == c && (e = d.dom.table.findCell(h, {
                        row: g.row,
                        col: g.col - 1
        ...
        exec: function (a) {
            ...
            return b.executeAndRestoreRangy(function () {
                for (var b = a.length; b--;)g = a[b], c = "OL" === g.parentNode.nodeName ? "OL" : "UL", e = g.ownerDocument.createElement(c), f = d.dom.domNode(g).prev({nodeTypes: [d.ELEMENT_NODE]}), h = f ? f.querySelector("ul, ol") : null, f && (h ? h.appendChild(g) : (e.appendChild(g), f.appendChild(e)), i = !0)
            }), i
        }
    }, d.commands.outdentList = {
        exec: function (a) {
            var b = a.selection.getSelectionParentsByTag("LI");
            ...
            var c, e, f, g, h, i = !1, j = this;
            return b.selection.executeAndRestoreRangy(function () {
                for (var k = a.length; k--;)if (g = a[k], g.parentNode && (c = g.parentNode, "OL" === c.tagName || "UL" === c.tagName)) {
                    if (i = !0, e = d.dom.getParentElement(c.parentNode, {nodeName: ["OL", "UL"]}, !1, b.element), f = d.dom.getParentElement(c.parentNode, {nodeName: ["LI"]}, !1, b.element), e && f)g.nextSibling && (h = j.getAfterList(c, g), g.appendChild(h)), e.insertBefore(g, f.nextSibling); else {
                        g.nextSibling && (h = j.getAfterList(c, g), g.appendChild(h));
                        for (var l = g.childNodes.length; l--;)c.parentNode.insertBefore(g.childNodes[l], c.nextSibling);
                        c.parentNode.insertBefore(document.createElement("br"), c.nextSibling), g.parentNode.removeChild(g)
                    }
        ...
        a.UndoManager = a.lang.Dispatcher.extend({
            constructor: function (a) {
                ...
                var b, c, d, e, i, j = this.historyStr[this.position - 1], k = this.composer.getValue(!1, !1), l = this.element.offsetWidth > 0 && this.element.offsetHeight > 0;
                if (k !== j) {
            ...
            name: "composer", CARET_HACK: "<br>", constructor: function (a, b, c) {
                ...
                if (e && this.commands.exec("autoUrlDetect", !1), this.config.autoLink) {
                    ...
                    b.observe(this.element, "keydown", function (a) {
                        if (g.length) {
                            var c, e = d.selection.getSelectedNode(a.target.ownerDocument), f = b.getParentElement(e, {nodeName: "A"}, 4);
                ...
                this.config.useLineBreaks || b.observe(this.element, ["focus", "keydown"], function () {
                    ...
                    if (!c.shiftKey && (h === a.ENTER_KEY || h === a.BACKSPACE_KEY)) {
                        var i = b.getParentElement(e.selection.getSelectedNode(), {nodeName: f}, 4);
        ...
        a.views.Composer.prototype.style = function () {
            var d, j = this, k = c.querySelector(":focus"), l = this.textarea.element, m = l.hasAttribute("placeholder"), n = m && l.getAttribute("placeholder"), o = l.style.display, p = l.disabled;
        ...
        var b = a.dom, c = a.browser, d = {66: "bold", 73: "italic", 85: "underline"}, e = function (a, b, c) {
            var d = a.getPreviousNode(b, !0), e = a.getSelectedNode();
            if (1 !== e.nodeType && e.parentNode !== c && (e = e.parentNode), d)if (1 == e.nodeType) {
                var f = e.firstChild;
                if (1 == d.nodeType)for (; e.firstChild;)d.appendChild(e.firstChild); else for (; e.firstChild;)b.parentNode.insertBefore(e.firstChild, b);
            ...
            if (b.isCollapsed())if (b.caretIsInTheBeginnig("LI"))a.preventDefault(), d.commands.exec("outdentList"); else if (b.caretIsInTheBeginnig())a.preventDefault(); else {
                if (b.caretIsFirstInSelection() && b.getPreviousNode() && b.getPreviousNode().nodeName && /^H\d$/gi.test(b.getPreviousNode().nodeName)) {
                    ...
                    if (a.preventDefault(), /^\s*$/.test(f.textContent || f.innerText))f.parentNode.removeChild(f); else {
        ...
        a.views.Composer.prototype.observe = function () {
            var e = this, h = this.getValue(!1, !1), i = this.sandbox.getIframe ? this.sandbox.getIframe() : this.sandbox.getContentEditable(), j = this.element, k = c.supportsEventsInIframeCorrectly() || this.sandbox.getContentEditable ? j : this.sandbox.getWindow(), l = ["drop", "paste"], m = ["drop", "paste", "mouseup", "focus", "keyup"];
            ...
            b.observe(k, m, function () {
                ...
                if (h !== e.getValue(!1, !1)) {
                    var b = a;
                    "function" == typeof Object.create && (b = Object.create(a, {type: {value: "change"}})), e.parent.fire("change", b).fire("change:composer", b)
                }
                ...
                var c = b.target, d = j.querySelectorAll("img"), f = j.querySelectorAll("." + e.config.uneditableContainerClassname + " img"), g = a.lang.array(d).without(f);
                ...
                if (a.metaKey || a.ctrlKey) {
                    var b = a.keyCode, c = j.ownerDocument.defaultView, d = c.getSelection();
                ...
                var c, d = e.selection.getSelectedNode(!0), f = b.keyCode;
    ...
    }(d), d.views.Textarea = d.views.View.extend({
        name: "textarea", constructor: function (a, b, c) {
            ...
            var a = d.browser.supportsPlaceholderAttributeOn(this.element), b = this.element.getAttribute("placeholder") || null, c = this.element.value, e = !c;
            return a && e || c === b
        }, isEmpty: function () {
            return !d.lang.string(this.element.value).trim() || this.hasPlaceholderSet()
        }, _observe: function () {
            var a = this.element, b = this.parent, c = {
                focusin: "focus",
                focusout: "blur"
            }, e = d.browser.supportsEvent("focusin") ? ["focusin", "focusout", "change"] : ["focus", "blur", "change"];
            b.on("beforeload", function () {
                d.dom.observe(a, e, function (a) {
                    var d = c[a.type] || a.type;
                    b.fire(d).fire(d + ":textarea")
                }), d.dom.observe(a, ["paste", "drop"], function () {
                    setTimeout(function () {
        ...
        var b = "wysihtml5-command-disabled", c = "wysihtml5-commands-disabled", d = "wysihtml5-command-active", f = "wysihtml5-action-active", g = a.dom;
        a.toolbar.Toolbar = e.extend({
            constructor: function (b, c, d) {
                ...
                var c, e, h, i, j = this.commandMapping, k = this.actionMapping;
                for (c in j)i = j[c], this.commandsDisabled ? (e = !1, g.removeClass(i.link, d), i.group && g.removeClass(i.group, d), i.dialog && i.dialog.hide()) : (e = this.composer.commands.state(i.name, i.value), g.removeClass(i.link, b), i.group && g.removeClass(i.group, b)), i.state !== e && (i.state = e, e ? (g.addClass(i.link, d), i.group && g.addClass(i.group, d), i.dialog && ("object" == typeof e || a.lang.object(e).isArray() ? (!i.dialog.multiselect && a.lang.object(e).isArray() && (e = 1 === e.length ? e[0] : !0, i.state = e), i.dialog.show(e)) : i.dialog.hide())) : (g.removeClass(i.link, d), i.group && g.removeClass(i.group, d), i.dialog && i.dialog.hide()));
    ...
    c.HandlebarsEnvironment = d, d.prototype = {
        constructor: d, logger: p, log: f, registerHelper: function (a, b, c) {
            if (n.call(a) === o) {
    ...
    var c = function (a, b) {
        ...
        d.prototype = {
            constructor: d, createEditor: function (c) {
                ...
                if (d.composer.editableArea.contentDocument ? this.addMoreShortcuts(d, d.composer.editableArea.contentDocument.body || d.composer.editableArea.contentDocument, c.shortcuts) : this.addMoreShortcuts(d, d.composer.editableArea, c.shortcuts), c && c.events)for (var e in c.events)d.on(e, c.events[e]);
