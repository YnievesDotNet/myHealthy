...
(function (e) {
        ...
        return e.prototype.rewrite = function (e) {
            ...
            return e = [], this.scanTokens(function (t, n, r) {
                ...
                H = t[0], T = (N = n > 0 ? r[n - 1] : [])[0], E = (n < r.length - 1 ? r[n + 1] : [])[0], O = function () {
                    ...
                    var s;
                    i == null && (i = !0), s = t != null ? t : n, e.push(["{", s, {
                        sameLine: !0,
                        startsLine: i,
                        ours: !0
    ...
    et = e("./rewriter"), F = et.Rewriter, w = et.INVERSES, tt = e("./helpers"), V = tt.count, Y = tt.starts, X = tt.compact, K = tt.last, G = tt.repeat, $ = tt.invertLiterate, Q = tt.locationDataToString, Z = tt.throwSyntaxError, t.Lexer = k = function () {
        ...
        return e.prototype.tokenize = function (e, t) {
            ...
            var e, t, n, r;
            return (n = p.exec(this.chunk)) ? (t = n[0], r = t.charAt(0), e = this.sanitizeHeredoc(n[2], {
                quote: r,
                indent: null
            }), r === '"' && 0 <= e.indexOf("#{") ? this.interpolateString(e, {
                heredoc: !0,
                strOffset: 3,
            ...
            var e, t, n;
            return (n = this.chunk.match(l)) ? (e = n[0], t = n[1], t && this.token("HERECOMMENT", this.sanitizeHeredoc(t, {
                herecomment: !0,
            ...
            while (l = t.charAt(o += 1)) {
                ...
                if (u.length) {
                    L = this.getLineAndColumnFromChunk(E + o + 1), h = L[0], r = L[1], d = (new e).tokenize(u, {
                        line: h,
                        column: r,
                        rewrite: !1
                    }), y = d.pop(), ((A = d[0]) != null ? A[0] : void 0) === "TERMINATOR" && (y = d.shift());
            ...
            for (o = C = 0, k = T.length; C < k; o = ++C)x = T[o], S = x[0], N = x[1], o && (o && (g = this.token("+", "+")), p = S === "TOKENS" ? N[0] : x, g[2] = {
            ...
            var n, r, i;
            return t == null && (t = 0), i = this.getLineAndColumnFromChunk(t), r = i[0], n = i[1], Z(e, {
                first_line: r,
                first_column: n
            })
        }, e
        ...
        performAction: function (t, n, r, i, s, o, u) {
            ...
            switch (s) {
                ...
                case 183:
                    ...
                    break;
                case 184:
                    this.$ = i.addLocationDataFn(u[a - 2], u[a])(new i.If(o[a], i.addLocationDataFn(u[a - 2])(i.Block.wrap([o[a - 2]])), {
                        type: o[a - 1],
                        statement: !0
                    }));
                    break;
    ...
    Error.stackTraceLimit = Infinity, W = e("./scope").Scope, Et = e("./lexer"), I = Et.RESERVED, z = Et.STRICT_PROSCRIBED, St = e("./helpers"), rt = St.compact, ut = St.flatten, ot = St.extend, pt = St.merge, it = St.del, gt = St.starts, st = St.ends, ct = St.last, mt = St.some, nt = St.addLocationDataFn, ht = St.locationDataToString, yt = St.throwSyntaxError, t.extend = ot, t.addLocationDataFn = nt, tt = function () {
        ...
        var t, n;
        return Tt(r, e), t = {"==": "===", "!=": "!==", of: "in"}, n = {
            "!==": "===",
            "===": "!=="
        }, r.prototype.children = ["first", "second"], r.prototype.isSimpleNumber = D, r.prototype.isUnary = function () {
            return !this.second
