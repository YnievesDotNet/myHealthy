        ...
        2: [function (e, t, n) {
            (function () {
                ...
                m.flatten = function (e, t) {
                    ...
                    if (typeof n == "number")r = n < 0 ? Math.max(0, i + n) : n; else if (n && i)return r = m.sortedIndex(e, t), e[r] === t ? r : -1;
        ...
        3: [function (e, t, n) {
            var r = e("underscore"), i = e("events"), s = e("./vars.js"), o = e("./messages.js"), u = e("./lex.js").Lexer, a = e("./reg.js"), f = e("./state.js").state, l = e("./style.js"), c = e("./options.js"), h = function () {
                ...
                function X(e, t, n, r, i, s, o) {
                    return W(e, {line: t, from: n}, r, i, s, o)
                }
                ...
                function $(e, t, n, r, i, s, o) {
                    return V(e, {line: t, from: n}, r, i, s, o)
                }
                ...
                function Z(e, t) {
                    ...
                    for (; ;) {
                        ...
                        if (f.tokens.next.isSpecial)Q(); else if (f.tokens.next.id !== "(endline)")break
                    }
                }
                ...
                function _t(e) {
                    ...
                    for (; ;) {
                        do n = G(t), t += 1; while (n.id != "(end)" && n.id === "(comment)");
                        if (n.reach)return;
                        if (n.id !== "(endline)") {
                            if (n.id === "function") {
                ...
                function jt(e, t, n, i, s) {
                    ...
                    } else V("E021", f.tokens.next, "{", f.tokens.next.value); else v["(nolet)"] = !0, (!t || f.option.curly) && W("W116", f.tokens.next, "{", f.tokens.next.value), f.tokens.next.inBracelessBlock = !0, w += f.option.indent, o = [Pt()], w -= f.option.indent, delete v["(nolet)"];
                    switch (v["(verb)"]) {
                        case"break":
                        case"continue":
                        case"return":
                ...
                function nn(e) {
                    if (f.option.inES5())for (var t in e)r.has(e, t) && e[t].setterToken && !e[t].getterToken && W("W078", e[t].setterToken)
                }
                ...
                function bn() {
                    function e() {
                        ...
                        if (f.tokens.next.id !== "}")for (; ;) {
                            if (f.tokens.next.id === "(end)")V("E026", f.tokens.next, t.line); else {
                                if (f.tokens.next.id === "}") {
                    ...
                    function t() {
                        ...
                        Z("[");
                        if (f.tokens.next.id !== "]")for (; ;) {
                            if (f.tokens.next.id === "(end)")V("E027", f.tokens.next, e.line); else {
                                if (f.tokens.next.id === "]") {
                                    W("W094", f.tokens.curr);
                                    break
                                }
                ...
                var e, t = {
                    ...
                    "/": !0,
                    "%": !0
                }, n, p, d = ["closure", "exception", "global", "label", "outer", "unused", "var"], v, m, g, y, b, w, E, S, x, T, N, C, k, L, A, O = [], M = new i.EventEmitter;
                vt("(number)", function () {
                    return this
                }), vt("(string)", function () {
                    return this
                    ...
                    type: "(identifier)", lbp: 0, identifier: !0, nud: function () {
                        ...
                        if (v === t || r)switch (r ? r[e]["(type)"] : v[e]) {
                            case"unused":
                            ...
                            case"global":
                                break;
                            default:
                                if (t === !0)v[e] = !0; else if (t === null)W("W039", f.tokens.curr, e), It(f.tokens.curr); else if (typeof t != "object")v["(comparray)"].check(e) || U(v, "W117", f.tokens.curr, e), v["(global)"] || (v[e] = !0), It(f.tokens.curr); else switch (t[e]) {
                                    case"function":
                                    case"unction":
                ...
                bt("||", function (e, t) {
                    ...
                    return f.option.esnext || W("W119", this, "spread/rest operator"), !f.tokens.next.identifier && f.tokens.next.type !== "(string)" && !mn(f.tokens.next, ["[", "("]) && V("E030", f.tokens.next, f.tokens.next.value), rt(150), this
                }), dt("!", function () {
                    ...
                    } else e.id !== "." && e.id !== "[" && e.id !== "(" && W("W056", f.tokens.curr); else f.option.supernew || W("W057", this);
                    ...
                    do e.value === "(" ? u += 1 : e.value === ")" && (u -= 1), n += 1, t = e, e = G(n); while ((u !== 0 || t.value !== ")") && e.value !== ";" && e.type !== "(end)");
                ...
                var on = ct("const", function (e) {
                    ...
                    for (; ;) {
                        var u = [];
                        r.contains(["{", "["], f.tokens.next.value) ? (i = rn(), o = !1) : (i = [{
                            id: Mt(),
                            token: f.tokens.curr
                        }], o = !0, n && (p[f.tokens.curr.value] = !0, f.tokens.curr.exported = !0));
                        for (var a in i)i.hasOwnProperty(a) && (a = i[a], v[a.id] === "const" && W("E011", null, a.id), v["(global)"] && N[a.id] === !1 && W("W079", a.token, a.id), a.id && (K(a.id, {
                            token: a.token,
                            type: "const",
                            unused: !0
                        }), u.push(a.token)));
                ...
                var un = ct("var", function (e) {
                    ...
                    for (; ;) {
                        ...
                        for (var l in i)i.hasOwnProperty(l) && (l = i[l], f.option.inESNext() && v[l.id] === "const" && W("E011", null, l.id), v["(global)"] && (N[l.id] === !1 ? W("W079", l.token, l.id) : f.option.futurehostile === !1 && (!f.option.inES5() && s.ecmaIdentifiers[5][l.id] === !1 || !f.option.inESNext() && s.ecmaIdentifiers[6][l.id] === !1) && W("W129", l.token, l.id)), l.id && (K(l.id, {
                            type: "unused",
                            token: l.token
                        }), a.push(l.token)));
                        if (t)break;
                ...
                var an = ct("let", function (e) {
                    ...
                    for (; ;) {
                        var a = [];
                        r.contains(["{", "["], f.tokens.next.value) ? (i = rn(), s = !1) : (i = [{
                            id: Mt(),
                            token: f.tokens.curr.value
                        }], s = !0, n && (p[f.tokens.curr.value] = !0, f.tokens.curr.exported = !0));
                        for (var l in i)i.hasOwnProperty(l) && (l = i[l], f.option.inESNext() && v[l.id] === "const" && W("E011", null, l.id), v["(global)"] && N[l.id] === !1 && W("W079", l.token, l.id), l.id && !v["(nolet)"] && (K(l.id, {
                            type: "unused",
                            token: l.token,
                            islet: !0
                        }), a.push(l.token)));
                ...
                an.exps = !0, ht("class", function () {
                    ...
                    var s, o = 0, u = ["in", "of"];
                    do s = G(o), ++o; while (!r.contains(u, s.value) && s.value !== ";" && s.type !== "(end)");
                    if (r.contains(u, s.value)) {
                        !f.option.inESNext() && s.value === "of" && V("W104", s, "for of");
                        if (f.tokens.next.id === "var")Z("var"), f.tokens.curr.fud({prefix: !0}); else if (f.tokens.next.id === "let")Z("let"), n = !0, v["(blockscope)"].stack(), f.tokens.curr.fud({prefix: !0}); else if (!f.tokens.next.identifier)V("E030", f.tokens.next, f.tokens.next.type), Z(); else {
                        ...
                        i && V("E045", i);
                        if (f.tokens.next.id !== ";")if (f.tokens.next.id === "var")Z("var"), f.tokens.curr.fud(); else if (f.tokens.next.id === "let")Z("let"), n = !0, v["(blockscope)"].stack(), f.tokens.curr.fud(); else for (; ;) {
                            rt(0, "for");
                            if (f.tokens.next.id !== ",")break;
                            at()
                        }
                    ...
                    return this.line === it(f.tokens.next) ? f.tokens.next.id !== ";" && !f.tokens.next.reach && (this.first = rt(0), this.first && this.first.type === "(punctuator)" && this.first.value === "=" && !this.first.paren && !f.option.boss && X("W093", this.first.line, this.first.character)) : f.tokens.next.type === "(punctuator)" && ["[", "{", "+", "-"].indexOf(f.tokens.next.value) > -1 && ot(this), _t(this), this
                }).exps = !0, function (e) {
                    e.exps = !0, e.lbp = 25
                }(dt("yield", function () {
                    var e = f.tokens.prev;
                    ...
                    if (f.tokens.next.id === "*")Z("*"), Z("as"), f.tokens.next.identifier && (this.name = Mt(), K(this.name, {
                        type: "unused",
                        token: f.tokens.curr
                    })); else {
                        Z("{");
                    ...
                    es5: !0,
                    strictOnly: !0
                }), gt("long"), gt("native"), gt("package", {es5: !0, strictOnly: !0}), gt("private", {
                    es5: !0,
                    strictOnly: !0
                }), gt("protected", {es5: !0, strictOnly: !0}), gt("public", {
                    es5: !0,
                    strictOnly: !0
                }), gt("short"), gt("static", {
                    es5: !0,
                ...
                var hn = function () {
                    ...
                    e = {
                        get isJSON() {
                            ...
                            X.apply(null, [e, t.line, t.char].concat(t.data))
                        }, on: function (e, t) {
                        ...
                        X.apply(null, [e.code, e.line, e.character].concat(e.data))
                    }), S.on("error", function (e) {
                        $.apply(null, [e.code, e.line, e.character].concat(e.data))
                    ...
                    try {
                        ...
                        m.forEach(function (e) {
                            ...
                            while (i) {
                                ...
                                if (s === "unused" || s === "unction")K(i, e["(tokens)"][i], "param", e["(unusedOption)"]); else if (o === "last-param")return;
                                i = n.pop()
                            }
                        });
                ...
                return Sn.addModule = function (e) {
                    ...
                    for (a in x)if (typeof x[a] == "number") {
                        e.member = x;
                        break
                    }
                    return e
