                        ...
                        <table width="264" border="0" cellpadding="0" cellspacing="0" align="left" class="force-row">
                            <tr>
                                <td class="col" valign="top"
                                    ...
                                    <br><br>
                                    <strong>{{trans('app.name')}}</strong> is the online reservation app for businesses.
                                    You have just registered, so we want to give you the welcome.
                                    <br><br>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table width="264" border="0" cellpadding="0" cellspacing="0" align="right" class="force-row">
                            <tr>
                                <td class="col" valign="top"
                                    ...
                                    <br><br>
                                    With <strong>{{trans('app.name')}}</strong> you will be able to easily make online
                                    service reservations or provide the appointments if you run a business.
                                    <br><br>
                                </td>
                            </tr>
                        </table>
                        ...
                        <div class="body-text"
                            ...
                            <ol>
                                <li>
                                    ...
                                    <strong>Yes!</strong> Taking and giving reservations is free. We also have featured
                                    plans if your business needs even more power.<br>
                                    <br>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <strong>No!</strong> Once you are registered, you may use the same credentials for
                                    any business.<br>
                                    <br>
                                </li>
                                <li>
                                    <strong>Any recommendation?</strong><br>
                                    <strong>Yes!</strong> Business do an important effort to give you the best service
                                    possible. Be on-time and respect your reservations. Remember you can always annulate
                                    in advance ant thats the best choice when you can't assist.<br>
                                    <br>
                                </li>
                            </ol>
                            ...
                            <a href="{!! route('user.businesses.home') !!}" style="color:#aaaaaa">Go to
                                timegrid.io</a><br>
                        </div>
