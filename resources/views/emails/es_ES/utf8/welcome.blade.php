            ...
            <table border="0" width="600" cellpadding="0" cellspacing="0" class="container"
                ...
                <tr>
                    <td class="container-padding content" align="left"
                        ...
                        <div class="title"
                             style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;color:#374550">{{ $user->name }}
                            , te damos la bienvenida a {{trans('app.name')}}</div>
                        <br>
                        ...
                        <table width="264" border="0" cellpadding="0" cellspacing="0" align="left" class="force-row">
                            <tr>
                                <td class="col" valign="top"
                                    ...
                                    <br><br>
                                    <strong>{{trans('app.name')}}</strong> es la agenda de turnos online que se
                                    administra sóla. Acabás de registrarte y por eso queremos darte la bienvenida.
                                    <br><br>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table width="264" border="0" cellpadding="0" cellspacing="0" align="right" class="force-row">
                            <tr>
                                <td class="col" valign="top"
                                    ...
                                    <br><br>
                                    Tanto si sos prestador de servicios o cliente,
                                    <strong>{{trans('app.name')}}</strong> te ayudará para que esto de los <strong>turnos</strong>
                                    sea casi un juego.
                                    <br><br>
                                </td>
                            </tr>
                        ...
                        <div class="body-text"
                            ...
                            <ol>
                                <li>
                                    ...
                                    <strong>Sí!</strong> Pedir y dar turnos es gratis. Si sos prestador y necesitás más
                                    potencia también tenemos un plan especial para tu negocio.<br>
                                    <br>
                                </li>
                                <li>
                                    <strong>¿Puedo empezar a pedir turnos?</strong><br>
                                    <strong>Sí!</strong> Pedir turnos es muy fácil. Buscás el prestador que te guste en
                                    nuestro directorio, lo hacés favorito, y ya podés pedirle turnos!<br>
                                    <br>
                                </li>
                                <li>
                                    <strong>¿Tengo que registrarme de nuevo por cada prestador?</strong><br>
                                    <strong>No!</strong> Ya te registraste! El mismo usuario te servirá para todos
                                    nuestros prestadores afiliados.<br>
                                    <br>
                                </li>
                                <li>
                                    <strong>¿Alguna recomendación?</strong><br>
                                    <strong>Sí!</strong> Los prestadores hacen lo mejor por darte el mejor servicio.
                                    Reservar y anular turnos ahora es bien fácil. Respetá los turnos y si no podés
                                    asistir, cancelalo a tiempo.<br>
                                    <br>
                                </li>
                            </ol>
                            ...
                            <a href="{!! route('user.businesses.home') !!}" style="color:#aaaaaa">Ir a
                                timegrid.io</a><br>
                        </div>
