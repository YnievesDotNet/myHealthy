...
return array (
  ...
  array (
    'alert' => 
    array (
      'deactivate_confirm' => '¡Atención! Desactivar el profesional es una operación IRREVERSIBLE. ¿Seguro desactivar?',
    ),
    'btn' => 
    array (
      'tooltip' => 
      array (
        ...
        'edit' => 'Editar datos del Profesional',
  ...
  array (
    'btn' => 
    array (
      'deactivate' => 'Desactivar este profesional',
      'store' => 'Registrar',
      'update' => 'Actualizar',
      'return' => 'Volver',
    ),
    ...
    'create' => 
    array (
      'title' => 'Registrar un profesional',
    ),
    'dashboard' => 
    array (
      'alert' => 
    ...
    array (
      ...
      array (
        'label' => 'Descripción',
        'placeholder' => 'Describe al profesional',
      ),
      'name' => 
      array (
        'label' => 'Nombre',
    ...
    'index' => 
    array (
      'help' => 'Desde aquí puedes administrar todos los profesionales',
      'register_business_help' => 'Si eres profesional y quieres dar turnos online, es tu oportunidad!',
      'title' => 'Mis Profesionales',
      'btn' => 
      array (
        'manage' => 'Administrar profesionales',
        'register' => 'Registrar un profesional',
      ),
    ),
    'msg' => 
    array (
      'create' => 
      array (
        'success' => '¡Hola! Vamos a registrarte con el plan :plan',
      ),
      'destroy' => 
      array (
        'success' => 'Profesional removido',
      ),
      'preferences' => 
      array (
      ...
      'store' => 
      array (
        'business_already_exists' => 'El profesional ya está registrado',
        'restored_trashed' => 'Profesional restaurado',
        'success' => 'Profesional registrado',
      ),
      'update' => 
      array (
        'success' => 'Datos del profesional actualizados',
      ),
    ),
    'preferences' => 
    array (
